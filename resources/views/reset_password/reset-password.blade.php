...
<body>
    ...
    <p>click this button to verify your email</p>
     <div class="mt-7">
    <a href="{{ route('change.password', $recoverToken) }}" class="no-underline text-white font-bold uppercase bg-btngreen pt-2 pl-10 pr-10 pb-2 rounded-md">Recover Password</a>
</div>   
</body>
</html>